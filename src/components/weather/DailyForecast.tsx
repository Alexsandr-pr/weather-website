    ...
    return (
        <section>
            <div className="mb-4 flex items-center justify-between">
                <h2 className="text-base hidden lg:block font-semibold text-slate-900 sm:text-lg px-4 md:px-0">
                    Prevision sur {items.length} jours
                </h2>
            </div>

            <div className="-mx-4 sm:-mx-6 hidden lg:block">
                    ...
                    {items.map((day, index) => {
                        ...
                        return (
                            <li
                                ...
                                className={`flex min-w-[96px] xl:min-w-[110px] flex-1 flex-col items-center gap-3 rounded-t-xl border bg-white p-0xl:p-1 py-2 xl:py-3 text-center transition ${isActive
                            ...
                            >
                                <button
                                    ...
                                    className="flex w-full cursor-pointer flex-col items-center gap-1.5 xl:gap-3 relative z-20"
                                >
                                    <div className="flex flex-col items-center leading-tight">
                                        <span className={`text-sm xl:text-base font-medium ${isActive ? "text-blue-700" : "text-slate-900"}`}>
                                            {day.dayName}
                                        </span>
                                    ...
                                    <WeatherConditionIcon
                                        ...
                                        className="h-10 xl:h-16 w-10 xl:w-16"
                                    />

                                    <div className="flex items-center gap-2 xl:gap-3 leading-none">
                                        <div className="flex flex-col items-center">
                                            <span className="text-[10px] xl:text-[11px] font-normal uppercase tracking-wide text-slate-500">
                                                min.
                                            </span>
                                            <span className="text-sm xl:text-lg font-medium text-slate-900">
                                                {day.low > 0 ? "+" : ""}
            ...
            <div className="relative z-10 md:rounded-xl md:border md:border-slate-200 bg-white py-3 md:p-3 shadow-[0_0_7px_0_rgba(0,0,0,.27)]">
